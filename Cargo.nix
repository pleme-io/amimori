  ...
  internal = rec {
    ...
    crates = {
      ...
      "tower" = rec {
        ...
        resolvedDefaultFeatures = [ "balance" "buffer" "discover" "futures-core" "futures-util" "indexmap" "limit" "load" "make" "pin-project-lite" "ready-cache" "slab" "sync_wrapper" "tokio" "tokio-util" "tracing" "util" ];
      };
      "tower-layer" = rec {
